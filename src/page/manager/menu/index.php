                ...
                <table class="text-sm w-full">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            if ($row["item_status"] == "Còn") {
                                echo "
                                    <tr>
                                        <td class='py-2'>#010" . $row["item_id"] . "</td>
                                        <td class='py-2'>" . $row["item_name"] . "</td>
                                        <td class='py-2'>" . $row["item_category"] . "</td>
                                        <td class='py-2'>" . $row["item_price"] . "</td>
                                        <td class='py-2'>" . $row["item_ingredient_quantity"] . "</td>
                                        <td class='py-2'><span class='bg-green-100 text-green-500 py-1 px-2 rounded-lg'>" . $row["item_status"] . "</span></td>
                                        <td class='py-2 flex'>
                                ...
                                echo "
                                    <tr>
                                        ...
                                        <td class='py-2'>" . $row["item_name"] . "</td>
                                        <td class='py-2'>" . $row["item_phone"] . "</td>
                                        <td class='py-2'>" . $row["item_address"] . "</td>
                                        <td class='py-2'>" . $row["item_position"] . "</td>
                                        <td class='py-2'><span class='bg-red-100 text-red-500 py-1 px-2 rounded-lg'>" . $row["item_status"] . "</span></td>
                                        <td class='py-2 flex'>
                                            <button class='btn btn-secondary mr-1'>Sửa</button>
                                            <button class='btn btn-danger ml-1'>Xóa</button>
                                        </td>
